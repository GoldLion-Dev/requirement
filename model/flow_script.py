...
class flow_model():
    ...
    def get_k_perturbation_range(self, max_range, save=True,
...
if __name__ == '__main__':
    ...
    # Lambda setting
    parser.add_argument('--max_step', type=int, default=1e-1,
                        help='(default: %(default)s)')
    parser.add_argument('--step_size', type=float, default=1e-6,
                        help='(default: %(default)s)')
