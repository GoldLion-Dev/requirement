...
def plot_pert_boxplot(active_files, names=None, dicts=None, title='None',sort=True, color=None, ax=None):     
...
def make_bar_plot(fname, name):
    ...
    plt.savefig("Data/plots/bar_plot.jpeg", bbox_inches='tight', dpi=300)
...
def make_error_plot(fname, max_rows=12):
    ...
    plt.savefig("Data/plots/error_plot.jpeg", bbox_inches='tight', dpi=300)
